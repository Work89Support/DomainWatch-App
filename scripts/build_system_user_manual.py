...
def add_role_table(doc):
    data = [
        ("แอดมินดูแลระบบ", "ทำได้ทุกอย่าง รวมผู้ใช้ บริษัท ลิงก์ เคส KPI และเครื่องตรวจ", "ทุกบริษัท"),
        ("หัวหน้าแอดมิน", "จัดการเคส/ลิงก์ ดู KPI และผู้ใช้ทั่วไป", "ทุกบริษัท"),
        ("ผู้ช่วยหัวหน้าแอดมิน", "จัดการเคส/ลิงก์ และดู KPI", "ทุกบริษัท"),
