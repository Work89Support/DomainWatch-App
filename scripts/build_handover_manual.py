...
def build_doc():
    ...
    p=doc.add_paragraph(); p.alignment=WD_ALIGN_PARAGRAPH.CENTER; r=p.add_run("เวอร์ชันเอกสาร 1.0  |  แอป Android 1.0.1  |  26 สิงหาคม 2569"); r.font.size=Pt(9); r.font.color.rgb=RGBColor.from_string(MUTED)
    ...
    add_steps(doc,[
        ("ดาวน์โหลด APK","จากหน้า /agents กด ดาวน์โหลด APK หรือใช้ไฟล์ DomainWatch-Agent-v1.0.1.apk ในชุดส่งมอบ"),
    ...
    add_callout(doc,"ตรวจลายเซ็นไฟล์","SHA‑256 ของ APK รุ่น 1.0.1: 628b326a6f770665dfeb8e24c4c80a3a57baaf01e7c4e73ffd4fdc081a3024b3","F0FDF4")
    ...
    rows=[
        ("deliverables/public/DomainWatch-Agent-v1.0.1.apk","ติดตั้งบนโทรศัพท์","แชร์ให้ทีมติดตั้งได้"),
