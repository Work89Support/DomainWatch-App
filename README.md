...
3. ใส่ env อื่น ๆ: `AUTH_SECRET` (สุ่มยาว ๆ — จำเป็น), `CRON_SECRET`,
   ...
   สำหรับฟังก์ชันลืมรหัสผ่าน ให้เพิ่ม `RESEND_API_KEY` และ `RESET_EMAIL_FROM`
   (อีเมลผู้ส่งจากโดเมนที่ยืนยันกับ Resend แล้ว)
...
- หากลืมรหัส ผู้ใช้กด **ลืมรหัสผ่าน?** ที่หน้าเข้าสู่ระบบ ลิงก์จะส่งไปยังอีเมลที่ผูกไว้เท่านั้น ใช้ได้ครั้งเดียวและหมดอายุใน 30 นาที
