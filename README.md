...
| --- | --- | --- |
| `ADMIN` | แอดมินดูแลระบบ ทำได้ทุกอย่าง รวมผู้ใช้ บริษัท ลิงก์ เคส KPI และเครื่องตรวจ | ทุกบริษัท |
| `ADMIN_LEAD` | จัดการเคส/ลิงก์ ดู KPI และจัดการผู้ใช้ทั่วไป (แตะบัญชี ADMIN ไม่ได้) | ทุกบริษัท |
| `ADMIN_COMPANY` | ผู้ช่วยหัวหน้าแอดมิน แก้ลิงก์/เคสและดู KPI | ทุกบริษัท |
