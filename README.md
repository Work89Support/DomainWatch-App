...
| --- | --- | --- |
| `ADMIN` | ทุกอย่าง รวมจัดการผู้ใช้และโครงสร้างบริษัท | ทุกบริษัท |
| `ADMIN_LEAD` | จัดการเคส/ลิงก์ และดู KPI แต่จัดการผู้ใช้ไม่ได้ | ทุกบริษัท |
| `ADMIN_COMPANY` | แก้ลิงก์และจัดการเคส | เฉพาะบริษัทที่เลือกในหน้าผู้ใช้ |
| `IT` | รับเรื่องฝั่งไอที ชี้แจงสาเหตุ และใส่ลิงก์สำรอง | ทุกบริษัท |
| `MANAGEMENT` | อ่านแดชบอร์ด รายงานรอบวัน และ KPI | ทุกบริษัท |
| `SITE_STAFF` | อ่านหน้าเครื่องตรวจเครือข่ายและดาวน์โหลด APK เท่านั้น ไม่มีสิทธิ์แก้ไข | เครื่องตรวจทั้งหมด |

- เมื่อเลือก `ADMIN_COMPANY` ต้องเลือกบริษัทอย่างน้อย 1 บริษัท ระบบจะกรองทั้งหน้าเว็บและ API
...
`public/downloads/DomainWatch-Agent-v1.0.6.apk` ผู้ใช้ดาวน์โหลดจากหน้าเครื่องตรวจได้โดยตรง แอปเลือกตรวจผ่านซิมโดยตรงหรือ VPN ที่เปิดอยู่บนโทรศัพท์ได้ โดยระบบเก็บเฉพาะเมือง/ภูมิภาค/ประเทศของ Public IP ทางออก ไม่เก็บ GPS หรือ IP จริง
