        ...
        >
          ...
          >
            <div className="flex min-h-14 shrink-0 items-center gap-2 bg-gradient-to-r from-brand-600 to-brand-700 px-3 text-white sm:px-4">
              ...
              <a href="/downloads/DomainWatch-User-Manual-v2.4.pdf" target="_blank" rel="noreferrer" className="rounded-lg bg-white/20 px-3 py-2 text-xs font-semibold text-white hover:bg-white/30">PDF</a>
              <a href="/downloads/DomainWatch-User-Manual-v2.4.docx" download className="hidden rounded-lg bg-white/20 px-3 py-2 text-xs font-semibold text-white hover:bg-white/30 sm:inline-flex">Word</a>
